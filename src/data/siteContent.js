...
export const processSteps = [
  {
    step: "01",
    title: "Site Survey",
    body: "We inspect access constraints, sequencing requirements, and stakeholder interfaces before design begins.",
  },
  {
    step: "02",
    title: "Planning & Design",
    body: "Our team develops a project-specific scaffold strategy aligned to programme, compliance, and trade access.",
  },
  {
    step: "03",
    title: "Scaffold Erection",
    body: "Experienced crews install in controlled phases to maintain safe routes and clear working areas.",
  },
  {
    step: "04",
    title: "Inspection & Safety Checks",
    body: "Systems are inspected, tagged, and released only when fully compliant with safety standards.",
  },
  {
    step: "05",
    title: "Ongoing Support",
    body: "We provide responsive adjustments, additions, and maintenance as project conditions evolve.",
  },
  {
    step: "06",
    title: "Dismantling",
    body: "Final strip-out is managed safely and efficiently with minimal disruption to site operations.",
  },
];
...
export const safetySections = [
  {
    ...
    body: "Structured pre-use and ongoing inspections are completed by competent personnel with documented records.",
  },
  {
    title: "Tagging Systems",
    body: "Clear scaffold tagging indicates status, limitations, and release conditions for all trades on site.",
  },
  {
    title: "Compliance",
    body: "All systems are delivered in line with Irish scaffolding and work-at-height requirements.",
  },
  {
    title: "Scaffold Safety Procedures",
    body: "Methodical erection, handover, and adaptation procedures reduce risk throughout the project lifecycle.",
  },
  {
    title: "Risk Management",
    body: "Site-specific hazards are assessed early and controlled through planning, sequencing, and supervision.",
  },
  {
    title: "Professional Standards",
    body: "ARC teams maintain high workmanship, communication, and housekeeping standards across every site.",
  },
];
